...
/*   Updated: 2022/06/21 14:25:30 by agirardi         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	update_player_position(t_data *data, double move_step)
{
	...
	test_x += cos(data->player.rot_angle) * (data->player.walk_direction
			* (data->player.move_speed + 5));
	test_y += sin(data->player.rot_angle) * (data->player.walk_direction
			* (data->player.move_speed + 5));
